...
export const metadata: Metadata = {
  ...
  description: "Como tratamos os dados coletados nesta landing de pesquisa (MVP).",
};
        ...
        <article className="bg-white rounded-2xl p-6 border shadow-sm">
          ...
          <ol className="space-y-4 text-slate-700 leading-relaxed">
            ...
            <li>
              ...
              <em>sem dados sensíveis de saúde do paciente</em>.
              <br />
            ...
            <li>
              ...
              <br />
              Dados armazenados em banco <em>PostgreSQL (Supabase)</em>.
              <br />
              Criptografia em trânsito (TLS) e Row Level Security habilitada.
              <br />
            ...
            <li>
              ...
              consentimento) e reclamar à autoridade.
            </li>

            <li>
              <strong>7. Contato do controlador</strong>
              <br />
              NovuSys — Contato/DPO:{" "}
              <a href="mailto:contato@novusys.com.br" className="underline">
                contato@novusys.com.br
              </a>
            </li>

            <li>
              <strong>8. Crianças e adolescentes</strong>
              <br />
              A landing não se destina a menores. Não coletamos dados de crianças/adolescentes.
            </li>

            <li>
              <strong>9. Alterações desta política</strong>
              <br />
